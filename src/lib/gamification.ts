...
export const RANKS: Rank[] = [
  { id: 'novice', name: 'Novic', minXp: 0, maxXp: 199, color: 'text-zinc-500', bgColor: 'bg-zinc-500/10', borderColor: 'border-zinc-500/30', icon: 'seedling' },
  { id: 'student', name: 'Student', minXp: 200, maxXp: 499, color: 'text-green-500', bgColor: 'bg-green-500/10', borderColor: 'border-green-500/30', icon: 'book' },
  { id: 'practitioner', name: 'Praktikant', minXp: 500, maxXp: 999, color: 'text-blue-500', bgColor: 'bg-blue-500/10', borderColor: 'border-blue-500/30', icon: 'stethoscope' },
  { id: 'specialist', name: 'Specialista', minXp: 1000, maxXp: 2499, color: 'text-cyan-500', bgColor: 'bg-cyan-500/10', borderColor: 'border-cyan-500/30', icon: 'award' },
  { id: 'expert', name: 'Expert', minXp: 2500, maxXp: 4999, color: 'text-amber-500', bgColor: 'bg-amber-500/10', borderColor: 'border-amber-500/30', icon: 'star' },
  { id: 'master', name: 'Mistr', minXp: 5000, maxXp: 9999, color: 'text-orange-500', bgColor: 'bg-orange-500/10', borderColor: 'border-orange-500/30', icon: 'crown' },
  { id: 'grandmaster', name: 'Velmistr', minXp: 10000, maxXp: 999999, color: 'text-red-500', bgColor: 'bg-red-500/10', borderColor: 'border-red-500/30', icon: 'flame' },
]
...
export const BADGES: BadgeDefinition[] = [
  ...
  },
  {
    id: 'lessons_5',
    name: 'Pilny student',
    description: 'Dokoncete 15 lekci',
    icon: 'book-open',
    xpReward: 50,
    category: 'lessons',
    condition: (s) => s.lessonsCompleted >= 15,
    reward: { type: 'subscription_days', value: '3', label: '3 dny predplatneho zdarma' },
  },
  {
    id: 'lessons_10',
    name: 'Znaly praktik',
    description: 'Dokoncete 30 lekci',
    icon: 'brain',
    xpReward: 100,
    category: 'lessons',
    condition: (s) => s.lessonsCompleted >= 30,
    reward: { type: 'promo_code', value: 'PRAKTIK15', label: '15% sleva na vsechny produkty' },
  },
  {
    id: 'lessons_25',
    name: 'Neustupny',
    description: 'Dokoncete 60 lekci',
    icon: 'target',
    xpReward: 200,
    category: 'lessons',
    condition: (s) => s.lessonsCompleted >= 60,
    reward: { type: 'subscription_days', value: '7', label: '7 dni predplatneho zdarma' },
  },
  {
    id: 'lessons_50',
    name: 'Marathonec',
    description: 'Dokoncete 100 lekci',
    icon: 'medal',
    xpReward: 400,
    category: 'lessons',
  ...
  },
  {
    id: 'lessons_200',
    name: 'Legenda',
    description: 'Dokoncete 200 lekci',
    icon: 'sparkles',
    xpReward: 800,
    category: 'lessons',
    condition: (s) => s.lessonsCompleted >= 200,
    reward: { type: 'discount', value: '40', label: '40% sleva na cokoliv v obchode' },
  },
  {
    id: 'first_course',
    name: 'Absolvent',
  ...
  },
  {
    id: 'courses_5',
    name: 'Akademik',
    description: 'Dokoncete 10 kurzu',
    icon: 'trophy',
    xpReward: 500,
    category: 'courses',
    condition: (s) => s.coursesCompleted >= 10,
    reward: { type: 'discount', value: '30', label: '30% sleva na cokoliv v obchode' },
  },
  {
    id: 'courses_15',
    name: 'Velmistr znalosti',
    description: 'Dokoncete 15 kurzu',
    icon: 'star',
    xpReward: 1000,
    category: 'courses',
    condition: (s) => s.coursesCompleted >= 15,
    reward: { type: 'discount', value: '50', label: '50% sleva na rocni predplatne' },
  },
  {
    id: 'streak_3',
    name: 'Na vlne',
  ...
  },
  {
    id: 'streak_30',
    name: 'Zelezna vule',
    description: '60 dni v rade aktivni',
    icon: 'shield',
  ...
  },
  {
    id: 'streak_100',
    name: 'Titan',
    description: '100 dni v rade aktivni',
    icon: 'mountain',
    xpReward: 500,
    category: 'streaks',
    condition: (s) => s.longestStreak >= 100,
    reward: { type: 'discount', value: '60', label: '60% sleva na mesicni predplatne' },
  },
  {
    id: 'xp_500',
    name: 'Stoupenec',
    description: 'Nasbirejte 1500 XP',
    icon: 'trending-up',
    xpReward: 50,
    category: 'special',
    condition: (s) => s.totalXp >= 1500,
    reward: { type: 'promo_code', value: 'XP1500SLEVA', label: '10% sleva na e-shop' },
  },
  {
    id: 'xp_2000',
    name: 'Veteran',
    description: 'Nasbirejte 5000 XP',
    icon: 'crown',
    xpReward: 200,
    category: 'special',
  ...
  },
  {
    id: 'xp_10000',
    name: 'Grandmaster',
    description: 'Nasbirejte 10000 XP',
    icon: 'gem',
    xpReward: 500,
    category: 'special',
    condition: (s) => s.totalXp >= 10000,
    reward: { type: 'discount', value: '75', label: '75% sleva na cokoliv' },
  },
]
